...
func: b
-----2-----
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="递归" tabindex="-1"><a class="header-anchor" href="#递归" aria-hidden="true">#</a> 递归</h2><div class="hint-container danger"><p class="hint-container-title">警告</p><p>暂略</p></div>`,10),c=[i];function p(d,l){return a(),s("div",null,c)}const u=n(t,[["render",p],["__file","5-2.html.vue"]]);export{u as default};
